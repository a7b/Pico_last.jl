...
prob = load_problem("/home/aditya/Pico.jl/data/multimode/fixed_time/no_guess/problems/g0_to_g1_T_120_dt_22.0_R_0.1_iter_800ubound_0.01_00000.jld2")
...
xf_1 = rollout(ket_to_iso(ψ1[1]), controls_matrix, dts, prob.system; integrator = Integrators.fourth_order_pade)[:, end]
xf_2 = rollout(ket_to_iso(ψ1[2]), controls_matrix, dts, prob.system; integrator = Integrators.fourth_order_pade)[:, end]
println(fidelity(xf_1, ket_to_iso(ψf[1])))
